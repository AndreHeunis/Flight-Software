...
typedef struct{
    ...
    uint8_t busyStatus; ///< 0 = idle. 1 = waiting for other operation to finish, 2 = Busy capturing photo. 3  = performing detection.
    uint8_t result; ///< 0 = no error. 1 = camera timeout, 2 = Detection error
...
typedef struct{
    ...
    uint8_t nadirPower; ///<
    uint8_t sunPower; ///<
    uint8_t nadirOvercurrent; ///<
    uint8_t sunOvercurrent; ///<
