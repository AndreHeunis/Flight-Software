...
#define BSP_ACMP_SRAM1 ACMP0 ///< ACMP channel used to monitor SRAM1.
#define	BSP_ACMP_SRAM2 ACMP1 ///< ACMP channel used to monitor SRAM2.

/**
 * @brief
 *   Threshold value for ACMP0 monitoring SRAM1.
 * @details
 *   The threshold value of 2 will cause ACMP0 to interrupt if SRAM1 draws more
 *   than 1mA current.
 * @note
...
#define BSP_ACMP_SRAM1_CHANNEL acmpChannel0
#elif defined(CubeCompV3)
#define BSP_ACMP_SRAM1_CHANNEL acmpChannel2
#endif
#define BSP_ACMP_SRAM2_CHANNEL acmpChannel0
